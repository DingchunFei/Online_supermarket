...
public class OrderServlet extends BaseServlet {
	...
	public String saveOrder(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		if(null==user){
			req.setAttribute("msg", "Please login before ordering!");
	...
	public String findMyOrders(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		//获取用户信息
		User user=(User)req.getSession().getAttribute("loginUser");
	...
	public String deleteOrderOrderItem(HttpServletRequest req, HttpServletResponse resp) throws Exception {

		String oid= req.getParameter("oid");
		OrderService orderService=new OrderServiceImp();
		orderService.deleteOrderOrderItem(oid);
		resp.sendRedirect(req.getContextPath()+"/OrderServlet?method=findMyOrders");
