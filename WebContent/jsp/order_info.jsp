			...
			<div class="row">
				...
				<div style="margin:0 auto;margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							<tr class="warning">
								<th colspan="5">Order No: ${requestScope.order.oid}</th>
							</tr>
							<tr class="warning">
								<th>Image</th>
								<th>Product</th>
				...
				<div style="text-align:right;margin-right:120px;">
					Address: <strong style="color:#ff6600;">${order.address}</strong>
				</div>
				<div style="text-align:right;margin-right:120px;">
					Total: <strong style="color:#ff6600;">$${order.total}</strong>
				</div>
