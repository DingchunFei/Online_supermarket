	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form class="form-horizontal" style="margin-top:5px;" action="${pageContext.request.contextPath}/UserServlet?method=userRegister" method="post">
			 <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" name="username" class="form-control" id="username" placeholder="Please input an username">
			    </div>
			  </div>
			   <div class="form-group">
			    <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
			    <div class="col-sm-6">
			      <input type="password" name="password" class="form-control" id="inputPassword3" placeholder="Please input an password">
			    </div>
			  </div>
<!-- 			   <div class="form-group">
...
<!-- 			 <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" name="name" class="form-control" id="usercaption" placeholder="Please input your name">
			    </div>
			  </div> -->
			...
			<label class="radio-inline">
			 ...
			 <%--  <div class="form-group">
			    <label for="date" class="col-sm-2 control-label">Verification</label>
			    <div class="col-sm-3">
			  ...
			  <div class="form-group">
			    <div class="col-sm-offset-2 col-sm-10">
			      <input type="submit"  width="100" value="Sign up" name="submit" border="0"
